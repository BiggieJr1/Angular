...
const ESTILOS_POR_CATEGORIA: Record<string, { gradienteBg: string; badgeColor: string; imagenUrl?: string }> = {
  ...
  DevOps: { gradienteBg: 'from-blue-500 to-cyan-500', badgeColor: 'bg-blue-100 text-blue-800', imagenUrl: 'img/categorias/devops.jpg' },
  'Bases de Datos': { gradienteBg: 'from-purple-500 to-indigo-500', badgeColor: 'bg-purple-100 text-purple-800', imagenUrl: 'img/categorias/bases-de-datos.jpg' },
  Ciberseguridad: { gradienteBg: 'from-slate-700 to-slate-900', badgeColor: 'bg-slate-200 text-slate-800', imagenUrl: 'img/categorias/ciberseguridad.jpg' },
  'Diseño UI/UX': { gradienteBg: 'from-fuchsia-500 to-purple-500', badgeColor: 'bg-fuchsia-100 text-fuchsia-800', imagenUrl: 'img/categorias/diseno-ui-ux.jpg' },
  Cloud: { gradienteBg: 'from-sky-400 to-blue-500', badgeColor: 'bg-sky-100 text-sky-800', imagenUrl: 'img/categorias/cloud.jpg' },
};
